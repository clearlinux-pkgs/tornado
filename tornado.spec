...
Version  : 4.4.3
Release  : 22
URL      : http://pypi.debian.net/tornado/tornado-4.4.3.tar.gz
Source0  : http://pypi.debian.net/tornado/tornado-4.4.3.tar.gz
...
%prep
%setup -q -n tornado-4.4.3

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491058419
